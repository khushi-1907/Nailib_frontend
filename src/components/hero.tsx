    ...
    return (
        ...
        >
            ...
            <div className="max-w-5xl mx-auto text-center relative z-10">
                <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-primary/10 border border-primary/30 text-primary text-xs font-bold tracking-widest uppercase mb-6">
                ...
                <div className="hero-buttons flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <Button
                        variant="outline"
                        className="w-full sm:w-auto px-8 py-4 border border-white/20 text-white font-bold rounded-2xl hover:bg-white/10 flex items-center justify-center gap-2"
                    >
