...
const CardsSection: FC = () => {
    ...
    return (
        <section ref={sectionRef} className="max-w-[1280px] mx-auto px-6 lg:px-20 py-24 bg-background-dark overflow-hidden">
            {/* Hero Title Section */}
            <div className="text-center mb-20 animate-fade-up">
                ...
                <div className="flex items-center justify-center gap-4 text-xs font-medium text-white/40 uppercase tracking-widest">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[240px]">
                ...
                <div className="md:col-span-8 md:row-span-2 bg-surface-dark rounded-xl card-border-premium inner-glow p-8 flex flex-col relative overflow-hidden group bento-card animate-fade-up">
                    <div className="flex justify-between items-start mb-8 relative z-10">
                        <div>
                            ...
                            <p className="text-white/50 text-sm max-w-md">2,000+ IB-style questions that learn your weaknesses and adjust difficulty in real-time.</p>
                        </div>
                        <div className="flex gap-2">
                            <span className="px-3 py-1 bg-accent-emerald/10 text-accent-emerald text-xs font-bold rounded-full border border-accent-emerald/20">Live</span>
                            <span className="px-3 py-1 bg-primary/10 text-primary text-xs font-bold rounded-full border border-primary/20">V.2.4</span>
                        </div>
                    </div>
                ...
                <div className="md:col-span-4 md:row-span-2 bg-surface-dark rounded-xl card-border-premium inner-glow p-8 overflow-hidden flex flex-col bento-card animate-fade-up">
                    <div className="mb-6">
                        ...
                        <p className="text-white/50 text-sm">7-Point exemplar library with examiner annotations.</p>
                    </div>
                    ...
                    <div className="mt-auto grid grid-cols-2 gap-2">
                        <button className="text-xs bg-white/5 hover:bg-white/10 py-2.5 rounded-full font-bold border border-white/10 transition-colors text-white">Browse Biology</button>
                        <button className="text-xs bg-white/5 hover:bg-white/10 py-2.5 rounded-full font-bold border border-white/10 transition-colors text-white">Browse Economics</button>
                    </div>
                </div>
                ...
                <div className="md:col-span-4 bg-surface-dark rounded-xl card-border-premium inner-glow p-6 flex flex-col justify-between group bento-card animate-fade-up">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-bold text-white/30 tracking-widest uppercase">Tracker</span>
                    </div>
                    <div>
                        <h4 className="text-lg font-bold text-white">Syllabus Progress</h4>
                        <p className="text-sm text-white/50">Auto-syncs with your drills.</p>
                    </div>
                ...
                <div className="md:col-span-4 bg-surface-dark rounded-xl card-border-premium inner-glow p-6 flex flex-col justify-between group bento-card animate-fade-up">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-bold text-white/30 tracking-widest uppercase">Retention</span>
                    </div>
                    <div>
                        <h4 className="text-lg font-bold text-white">Flashcard Mastery</h4>
                        <p className="text-sm text-white/50">Spaced-repetition for definitions.</p>
                    </div>
                ...
                <div className="md:col-span-4 bg-surface-dark rounded-xl card-border-premium inner-glow p-6 flex flex-col justify-between group bento-card animate-fade-up">
                    <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-bold text-white/30 tracking-widest uppercase">Expert AI</span>
                    </div>
                    <div>
                        <h4 className="text-lg font-bold text-white">Detailed Markschemes</h4>
                        <p className="text-sm text-white/50">Understand exactly why you lost points.</p>
                    </div>
