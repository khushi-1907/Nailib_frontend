...
export default function Footer() {
  return (
    <footer className="bg-deep-navy border-t border-white/5 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a className="text-slate-500 hover:text-white transition-colors" href="#"><Globe size={20} /></a>
              <a className="text-slate-500 hover:text-white transition-colors" href="#"><YoutubeLogo size={20} /></a>
              <a className="text-slate-500 hover:text-white transition-colors" href="#"><EnvelopeSimple size={20} /></a>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm text-slate-400 mb-6">Get the latest IB tips and resource updates directly.</p>
            <div className="flex gap-2">
              <input
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all text-white placeholder:text-slate-600"
        ...
        <div className="pt-10 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-xs text-slate-500">© 2016-2024 NAIL IB. All rights reserved. A product of Turnix.</p>
